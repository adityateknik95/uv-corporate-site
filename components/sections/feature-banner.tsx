 ...
 * raised surface with a brass rule top and bottom, keeping the one-accent
...
export function FeatureBanner({ content }: { content: FeatureBannerContent }) {
  return (
    <div className="border-y border-brass/30 bg-surface">
      <Container className="flex flex-col items-start gap-8 py-16 sm:flex-row sm:items-center sm:justify-between lg:py-20">
        ...
        <a
          ...
          className="inline-flex h-[50px] shrink-0 items-center rounded-md bg-brass px-6 text-body font-medium text-ground transition-colors duration-200 ease-in-out hover:bg-fg"
        >
          {content.cta.label}
        </a>
      </Container>
